...
void setup() {
    ...
    Enes100.begin("V8 Engine", HYDROGEN, 205, 1116);
    ...
    // Enes100.begin("V8 Engine", HYDROGEN, 205, 1116, 3, 2);
...
void loop() {
    ...
    // Transmit the color of the LED (WHITE, RED, YELLOW, GREEN, BLUE)
    Enes100.mission(LED_COLOR, BLUE);
    // Transmit the VOLTAGE_OUTPUT of the fuel cell (VOLTAGE_1 through VOLTAGE_5)
    Enes100.mission(VOLTAGE_OUTPUT, VOLTAGE_3);
    delay(1000);
}